# 📖 [Bucket_List] <a name="about-project"></a>
...
- **[Add Wish]** - Add your wish.
- **[Display all wishes]** - Display recent wishes.
- **[Delete wish ]** - Delete specific wish.
...
```bash command
$ git clone $ git clone https://github.com/edi-sipka/Bucket_List_Rails
```
...
```bash command
you@your-Pc-name:~$ cd <Bucket_List_Rails>
```
...
- **[Can I add likes on wish?]**

  - [You can add likes and comments on a wish.]
